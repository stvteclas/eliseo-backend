"""
Credenciales de Mercado Pago por usuario y cuenta (HU-T20, multi-cuenta
desde HU-T21), cifradas con Fernet (ver app/core/crypto.py). Los links de
pago se crean con el access token DEL USUARIO, así que la plata entra a su
cuenta y no a una de la app.
"""
...
class MercadoPagoCredential(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "account_label", name="uq_mercadopago_credentials_user_account"),)
